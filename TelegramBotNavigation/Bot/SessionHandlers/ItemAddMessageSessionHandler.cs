...
{
    public class ItemAddMessageSessionHandler : ISessionHandler
    {
        public string Action => SessionKeys.NavigationItemAddMessage;
        ...
        private readonly ILogger<ItemAddMessageSessionHandler> _logger;
        private readonly ITranslationService _translationService;
        private readonly INavigationMessageService _navigationMessageService;

        public ItemAddMessageSessionHandler(
            ...
            ILogger<ItemAddMessageSessionHandler> logger,
        ...
        public async Task HandleAsync(Message message, SessionData session, CancellationToken ct)
        {
            ...
            if (!InputValidator.IsValidText(messageText))
            {
            ...
            if (actionType != MenuActionType.ShowMessage)
            {
            ...
            var newItem = new MenuItem
            {
                ...
                MessageTranslationKey = $"menuitem.message.{Guid.NewGuid()}",
                Row = lastRow + 1,
                Order = 0,
            };
            ...
            await _translationService.SetTranslationAsync(newItem.MessageTranslationKey, LanguageCodeHelper.FromTelegramTag(langStr), messageText);
