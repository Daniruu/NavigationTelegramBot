...
{
    public class DeleteHeaderImageConfirmationCallbackHandler : ICallbackHandler
    {
        public string Key => CallbackKeys.DeleteHeaderImageConfirmation;

        private readonly IUserRepository _userRepository;
        private readonly IUserService _userService;
        private readonly ITelegramMessageService _messageService;
        private readonly ILocalizationManager _localizer;
        private readonly ILogger<DeleteHeaderImageConfirmationCallbackHandler> _logger;
        private readonly IMenuRepository _menuRepository;
        private readonly ICallbackAlertService _callbackAlertService;

        public DeleteHeaderImageConfirmationCallbackHandler(
            IUserRepository userRepository,
            IUserService userService,
            ITelegramMessageService messageService,
            ILocalizationManager localizer,
            ILogger<DeleteHeaderImageConfirmationCallbackHandler> logger,
        ...
        public async Task HandleAsync(CallbackQuery query, string[] args, CancellationToken ct)
        {
            ...
            var template = await DeleteHeaderImageConfirmationTemplate.CreateAsync(menu.Id, user.LanguageCode, languageCode, _localizer);
