...
{
    public class DeleteHeaderImageCallbackHandler : ICallbackHandler
    {
        public string Key => CallbackKeys.DeleteHeaderImage;

        private readonly IUserRepository _userRepository;
        private readonly IUserService _userService;
        private readonly ITelegramMessageService _messageService;
        private readonly ILocalizationManager _localizer;
        private readonly ILogger<DeleteHeaderImageCallbackHandler> _logger;
        ...
        public DeleteHeaderImageCallbackHandler(
            IUserRepository userRepository,
            IUserService userService,
            ITelegramMessageService messageService,
            ILocalizationManager localizer,
            ILogger<DeleteHeaderImageCallbackHandler> logger,
        ...
        public async Task HandleAsync(CallbackQuery query, string[] args, CancellationToken ct)
        {
            ...
            await _translationImageService.DeleteTranslationImageAsync(menu.HeaderImageTranslationKey, languageCode);
