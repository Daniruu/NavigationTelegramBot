...
{
    public class ItemEditUrlCallbackHandler : ICallbackHandler
    {
        public string Key => CallbackKeys.ItemEditUrl;

        private readonly IUserRepository _userRepository;
        private readonly IUserService _userService;
        private readonly ITelegramMessageService _messageService;
        private readonly ILocalizationManager _localizer;
        private readonly ILogger<ItemEditUrlCallbackHandler> _logger;
        private readonly IMenuRepository _menuRepository;
        private readonly ILanguageSettingRepository _languageSettingRepository;
        private readonly ISessionManager _sessionManager;

        public ItemEditUrlCallbackHandler(
            IUserRepository userRepository,
            IUserService userService, ITelegramMessageService messageService,
            ILocalizationManager localizer,
            ILogger<ItemEditUrlCallbackHandler> logger,
        ...
        public async Task HandleAsync(CallbackQuery query, string[] args, CancellationToken ct)
        {
            ...
            {
                Action = SessionKeys.NavigationItemEditUrl,
            ...
            var prompt = await _localizer.GetInterfaceTranslation(LocalizationKeys.Messages.EnterButtonUrl, user.LanguageCode, languageCode.GetDisplayLabel());
