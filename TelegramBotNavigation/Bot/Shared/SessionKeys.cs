namespace TelegramBotNavigation.Bot.Shared
{
    ...
    {
        public const string WelcomeEdit = "welcome.edit";
        public const string NavigationAdd = "navigation.add_menu";
        public const string NavigationItemSelectType = "navigation.item.select_type";
